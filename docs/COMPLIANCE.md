...
SlideBridge Core is designed as a clean public core for research and algorithm development.

- It does not include proprietary SDKs.
- It does not include proprietary format implementations.
